...
return (
    <main className='max-w-md px-2 mx-auto'>
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className='flex align-center justify-center'>
            ...
            w-full mr-3
            ${type==="rent" ? 'bg-white test-black' : 'bg-slate-600 text-white'}`
            }>
                Sell
            </button>
        ...
        maxLength='32' minLength='8' required
        ...
        <div className='flex align-center justify-center'>
            ...
            hover:shadow-lg focus:shadow-lg active-shadow-lg transition ease-in-out
            w-full mr-3
            ${!parking ? 'bg-white test-black' : 'bg-slate-600 text-white'}`
            }>
                Yes
            </button>
        ...
        <div className='flex align-center justify-center'>
            ...
            hover:shadow-lg focus:shadow-lg active-shadow-lg transition ease-in-out
            w-full mr-3
            ${!furnished ? 'bg-white test-black' : 'bg-slate-600 text-white'}`
            }>
                Yes
            </button>
        ...
        <div className='flex align-center justify-center'>
            ...
            hover:shadow-lg focus:shadow-lg active-shadow-lg transition ease-in-out
            w-full mr-3
            ${!offer ? 'bg-white test-black' : 'bg-slate-600 text-white'}`
            }>
                Yes
            </button>
    ...
    <div className='flex items-center mb-6'>
        ...
        <p className='text-lg mt-6 font-semibold'>Regular Price</p>
            ...
            <input type='number' id='regularPrice' value={regularPrice}
                ...
                text-center'
                />
                {type==='rent' && (<div><p className='text-md w-full whitespace-nowrap'>Rupee/Month</p></div>)}
            </div>
    ...
    <div className='mb-6'>
        ...
        onChange={onChange} accept='.jpg, .jpeg, .png'
        multiple required
    ...
    bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg
