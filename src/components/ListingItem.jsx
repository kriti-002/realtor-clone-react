  ...
  return (
    <li className='relative bg-white flex flex-col justify-between items-center shadow-md hover:shadow-xl rounded-md overflow-hidden transition-shadow duartion-150 m-[10px]'>
        ...
        to={`/category/${listing.type}/${id}`}>
            ...
            loading="lazy" src={listing.imgUrls[0]} alt='listing' />
            ...
            <p className='text-[#457b9d] mt-2 font-semibold'>Rupee {listing.offer ? listing.discountedPrice.toString()
        ...
        {onEdit && (
            <>
                <MdEdit className='absolute bottom-2 right-7 h-[14px] cursor-pointer text-blue-600'
